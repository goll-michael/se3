...
public class KundenContainer {
	...
	private KundenContainer() {
		/*
		 * Gespeicherte Daten einlesen. Falls noch keine Daten gespeichert wurden, kann
		 * keine Datei gelesen werden, es gibt dann eine Ausnahme
		 */
		...
		try {
			...
			/*
			 * Wenn keine Daten gelesen werden konnten, muss eine neue Datenbasis angelegt
			 * werden
			 */
