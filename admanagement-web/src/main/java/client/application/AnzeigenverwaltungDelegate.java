...
public class AnzeigenverwaltungDelegate
{
	...
	private AnzeigenverwaltungDelegate()
	{
		try {	
			 ...
			 */
			anzeigenverwaltung =
				(AnzeigenverwaltungRemote) ctx.lookup("ejb:amWEB-Server-ear/amWEB-Server-jar/Anzeigenverwaltung!server.schnittstelle.geschaeftslogik.AnzeigenverwaltungRemote");
		}
