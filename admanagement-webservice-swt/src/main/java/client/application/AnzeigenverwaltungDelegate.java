...
public class AnzeigenverwaltungDelegate
{
	...
	private AnzeigenverwaltungDelegate()
	{
		try {	
			 ...
			 */
			anzeigenverwaltung =
				(AnzeigenverwaltungRemote) ctx.lookup("ejb:amWS-SWT-Server-ear/amWS-SWT-Server-jar/Anzeigenverwaltung!server.schnittstelle.geschaeftslogik.AnzeigenverwaltungRemote");
		}
