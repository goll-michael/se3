...
public class AnzeigenverwaltungDelegate
{
	...
	private AnzeigenverwaltungDelegate()
	{
		try {	
			 ...
			 */
			anzeigenverwaltung =
				(AnzeigenverwaltungRemote) ctx.lookup("ejb:amWS-ET-Server-ear/amWS-ET-Server-jar/Anzeigenverwaltung!server.schnittstelle.geschaeftslogik.AnzeigenverwaltungRemote");
		}
